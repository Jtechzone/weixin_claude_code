...
/** Detect file extension from buffer magic bytes. Falls back to defaultExt (default ".jpg"). */
export function getExtensionFromBuffer(buf: Buffer, defaultExt = ".jpg"): string {
  if (buf.length < 4) return defaultExt;
